...
ZENOSS_INSTANCE = config.zenosshost
ZENOSS_USERNAME = config.zenossuser
ZENOSS_PASSWORD = config.zenosspass
ENV='dev'
...
class zenossapi:
	...
	def get_devices(self, deviceClass='/zport/dmd/Devices', prodstate=None):
		...
		return self._router_request('DeviceRouter', 'getDevices',
										...
										#{'keys': ['eventState', 'severity', 'component', 'eventClass', 'summary', 'firstTime', 'lastTime', 'count', 'evid', 'eventClassKey', 'message']}])['result']
	...
	def add_device(self, deviceName, deviceClass='/zport/dmd/Devices'):
